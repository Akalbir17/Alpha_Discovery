...
CREATE USER IF NOT EXISTS grafana_user WITH PASSWORD 'grafana_password';
CREATE USER IF NOT EXISTS jupyter_user WITH PASSWORD 'jupyter_password';
...
RETURNS TABLE(symbol VARCHAR(20), price DECIMAL(15,6), time TIMESTAMPTZ) AS $$
BEGIN
    RETURN QUERY
